...
from miles.utils.ft.platform.ray.training_job import (
    RayTrainingJob,
    _parse_ray_status,
    _stop_job,
...
class TestSubmitTraining:
    ...
    async def test_excluded_node_ids_appended_to_entrypoint(self) -> None:
        ...
        with patch("miles.utils.ft.platform.ray.node_discovery.ray") as mock_ray:
...
class TestStopTraining:
    ...
    async def test_stop_raises_timeout_error(self) -> None:
        ...
        with patch("miles.utils.ft.platform.ray.training_job.time") as mock_time, patch(
...
class TestStopJob:
    ...
    async def test_raises_immediately_when_stop_rpc_exhausts_timeout_budget(self) -> None:
        ...
        with patch("miles.utils.ft.platform.ray.training_job.time") as mock_time:
