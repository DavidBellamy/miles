...
from miles.backends.megatron_utils.weight_checksum import dump_weight_checksums
...
def save_hf_model(args, rollout_id: int, model: Sequence[DDP]) -> None:
    ...
    """
    should_log = get_parallel_state().effective_dp_cp.rank == 0 and mpu.get_tensor_model_parallel_rank() == 0
