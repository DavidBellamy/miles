...
def create_fsdp_parallel_state(args: Namespace) -> ParallelState:
    ...
    parallel_state = ParallelState(
        intra_dp_rank=dp_rank,
        intra_dp_src_rank=dp_rank // world_size,
        intra_dp_size=world_size // cp_size,
        cp_rank=cp_rank,
        cp_size=cp_size,
        intra_dp_cp_rank=rank,
        intra_dp_cp_size=world_size,
        intra_dp_group=mesh.get_group("dp"),
        intra_dp_cp_group=dist.group.WORLD,
        intra_dp_cp_group_gloo=get_gloo_group(),
