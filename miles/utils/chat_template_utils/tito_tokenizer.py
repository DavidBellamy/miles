...
class TITOTokenizer:
    """Incremental tokenization and prefix merging using dummy-prefix diff.
    ...
    token quirks (e.g. Qwen3's trailing newline, GLM 4.7's ambiguous
    stop-token / next-turn-start overlap).
    """
